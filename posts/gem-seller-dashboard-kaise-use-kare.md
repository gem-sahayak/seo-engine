...
description: "GeM Portal ke Seller Dashboard options, Bids tabs, Order status aur Caution Money status ko check aur manage karne ki complete walkthrough step-by-step in Hinglish."
...
cta: "Bidding and order workflows ko manage karne ke liye SahayakAI tools use karein"
keyTakeaways:
  - "Dashboard Navigation & Main Menu Options"
  - "Bids Tabs tracking (Ongoing & Participated)"
  - "Order Lifecycle milestones (PRC, CRAC status)"
  - "Caution Money Deposit & Virtual Account check"
faqs:
  - question: "GeM Caution Money status kaise check karein?"
    answer: "Dashboard me login karke profile section me Caution Money option par click karein aur apna active status aur bank linkage verify karein."
relatedTools:
  - "GeM Bidding Assistant"
  - "Caution Money Deposit Calculator"
relatedArticles:
  - "gem-login-kaise-kare"
  - "gem-registration-kaise-kare"
  - "profile-completion"
related_entities: ['GeM Seller', 'Caution Money', 'Incident Management', 'Bid Portal']
related_articles: ['gem-login-kaise-kare', 'gem-registration-kaise-kare', 'profile-completion']
user_journey_stage: 'Profile'
intent: 'HowTo'
difficulty: 'Beginner'
verifiedFor: "2026 Procurement Rules"
primaryKeyword: "gem seller dashboard kaise use kare"
secondaryKeywords:
  - "gem bids tabs option hindi"
  - "gem order status tracking guide"
  - "gem caution money deposit status check"
  - "gem dashboard options explained"
schemaTypes:
  - "HowTo"
  - "FAQPage"
  - "Article"
  - "BreadcrumbList"
ogTitle: "GeM Seller Dashboard Kaise Use Kare? Complete Guide 2026"
ogDescription: "GeM portal seller dashboard ke options, bids tabs, order status aur caution money status ko check aur manage karne ki step-by-step guide in Hinglish."
ogType: "article"
...
<div class="hero-summary-box">
  <p><strong>GeM Portal par login karne ke baad Seller Dashboard ko sahi tarike se navigate karna business growth ke liye sabse zaroori step hai.</strong> Agar aapko dashboard options, bids tracking, order execution timeline aur Caution Money account manage karne ki poori samajh nahi hogi, toh orders cancel ho sakte hain ya bids miss ho sakti hain. Is guide me hum aapko live orders track karne aur account health active rakhne ka complete process natural Hinglish me samjhayenge.</p>
</div>

---

<div class="quick-answer-box">
  <h3>⚡ Quick Answer: GeM Seller Dashboard Overview</h3>
  <table>
    <tr>
      <td><strong>Dashboard Definition</strong></td>
      <td>GeM portal par login karne ke baad milne wala centralized admin page jahan se catalog, orders, payments aur bids manage hote hain.</td>
    </tr>
    <tr>
      <td><strong>Bids Management</strong></td>
      <td>'Bids' menu ke under 'Ongoing Bids' se participate karein aur 'Participated Bids' se status trace karein.</td>
    </tr>
    <tr>
      <td><strong>Order Workflow</strong></td>
      <td>Orders receive hone par 5 days ke andar accept karna mandatory hai, warna system order cancel kar deta hai.</td>
    </tr>
    <tr>
      <td><strong>Caution Money Status</strong></td>
      <td>Sellers ko turnover ke mutabik ₹5,000, ₹10,000 ya ₹25,000 caution money bank account me deposit karna hota hai. Check status under 'Caution Money' tab.</td>
    </tr>
    <tr>
      <td><strong>Recommended Tool</strong></td>
      <td>Dashboard options ko clean dekhne aur bidding analytics auto-extract karne ke liye hamare free <strong>SahayakAI Chrome Extension</strong> ka use karein.</td>
    </tr>
  </table>
</div>
...
|---|---|
| **Process Time** | 5–10 Minutes to verify all tabs |
...
6. [Step-by-Step Guide: GeM Seller Dashboard Navigation](#step-by-step-guide-gem-seller-dashboard-navigation)
7. [Bids Tabs Explained (How to Track & Participate)](#bids-tabs-explained-how-to-track--participate)
8. [Order Lifecycle & Status Tracking](#order-lifecycle--status-tracking)
9. [Caution Money Status & Management](#caution-money-status--management)
10. [Decision Tree: Dashboard Action Flow](#decision-tree-dashboard-action-flow)
11. [⚠️ Important Warning Box](#️-important-warning-box)
12. [Comparison Table: GeM Dashboard Management vs Traditional Tendering](#comparison-table-gem-dashboard-management-vs-traditional-tendering)
...
|---|---|---|---|
| **Slab 1 (Micro/Small)** | Up to ₹1 Crore | **₹5,000** | Balance falls below ₹5,000 |
| **Slab 2 (Medium)** | Above ₹1 Crore to ₹10 Crore | **₹10,000** | Balance falls below ₹10,000 |
| **Slab 3 (Large)** | Above ₹10 Crore | **₹25,000** | Balance falls below ₹25,000 |
...
```
                  [New Order Received on Dashboard]
                                 │
                                 ▼ (Must accept within 5 Days SLA)
                        [Accepted Order]
                                 │
                                 ▼ (Generate Invoice & Enter Dispatch)
                       [Processing/Dispatched]
                                 │
                                 ▼ (Buyer issues within 48 Hours)
                  [PRC (Provisional Receipt)]
                                 │
                                 ▼ (Buyer inspects within 10 Days)
...
3. **Fund Transfer Process**:
   ...
   - Required balance amount (₹5,000 se ₹25,000 depending on turnover) code select karke transfer karein via NEFT/RTGS.
...
Participated Bids               │                        │
       │                 ├── YES: Accept < 5 days   ├── YES: Continue Bidding
       ▼                 └── NO: Check PRC/CRAC     └── NO: Deposit to Virtual
Trace Evaluation                  │                        Account (VAN)
...
> [!WARNING]
> **Dashboard Violations & Suspended Account Penalties:**
...
> - **Core Summary**: GeM Seller Dashboard is the central control system where registered sellers monitor their profile, upload catalogues, participate in bids, manage orders, and keep track of Caution Money. In 2026, sellers must adhere to a 5-day order acceptance SLA, maintain their specific Caution Money slab (₹5k/₹10k/₹25k) via linked bank virtual account, and monitor CRAC (Consignee Receipt and Acceptance Certificate) milestones to avoid payment delays.
...
GeM portal security integrity check ke liye seller se caution money charge karta hai. Turnover ke base par slabs: Up to ₹1 Cr turnover - ₹5,000, ₹1 Cr to ₹10 Cr - ₹10,000, aur Above ₹10 Cr - ₹25,000 hai.
...
Buyer’s DDO (Drawing and Disbursing Officer) jab system par bank transaction complete karta hai, tab automatic ledger sync se billing status 'Paid' show hota hai.
...
<div class="knowledge-journey-container">
  <div class="journey-step previous-step">
    ...
    <strong><a href="/posts/gem-login-kaise-kare">GeM Login Guide</a></strong>
  </div>
  <div class="journey-arrow">↓</div>
  <div class="journey-step current-step">
    <span class="journey-label">Current Guide</span>
    <strong>GeM Seller Dashboard Kaise Use Kare</strong>
  </div>
  <div class="journey-arrow">↓</div>
  <div class="journey-step next-step">
    <span class="journey-label">Next Step</span>
    <strong><a href="/posts/profile-completion">Profile Completion 100% Checklist</a></strong>
  </div>
</div>
...
<div class="extension-cta-box">
  <h3>🧩 SahayakAI Tools Se Apni Bidding Ko Supercharge Karein!</h3>
  <p>Apne GeM dashboard par bids aur orders ko bina session logouts ke fast monitor karne ke liye, aur real-time notifications pane ke liye, hamara free **SahayakAI Chrome Extension** abhi install karein. Direct live tender alerts seedhe WhatsApp par pane ke liye register karein.</p>
</div>
...
- **GeM Seller Helpdesk**: [gem.gov.in/support/sellers](https://gem.gov.in/support/sellers)
- **GeM Bidding Manuals**: [gem.gov.in/training](https://gem.gov.in/training)
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://sahayakai.co.in/posts/gem-seller-dashboard-kaise-use-kare#article",
      "headline": "GeM Seller Dashboard Kaise Use Kare? Options, Bids & Caution Money",
      "description": "GeM portal seller dashboard ke options, bids tabs, order status aur caution money status ko check aur manage karne ki step-by-step guide in Hinglish.",
    ...
    {
      "@type": "HowTo",
      "@id": "https://sahayakai.co.in/posts/gem-seller-dashboard-kaise-use-kare#howto",
      "name": "GeM Seller Dashboard Management",
      "description": "How to navigate and manage GeM seller dashboard options, bids, orders, and caution money.",
      "totalTime": "PT10M",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Seller Dashboard me Login Karein",
          "text": "gem.gov.in par login karke central seller dashboard dashboard open karein."
        },
        {
          "@type": "HowToStep",
          "name": "Bids Tab Navigate Karein",
          "text": "Bids menu se Ongoing Bids aur Participated Bids ke parameters check karein."
        },
        {
          "@type": "HowToStep",
          "name": "Orders Status Process Karein",
          "text": "Active orders ko accept karein aur PRC/CRAC milestones update hone par invoice clear karein."
        },
        {
          "@type": "HowToStep",
          "name": "Caution Money Active Status Ensure Karein",
          "text": "Caution money tab me virtual account create karke turnover limit ke anusar deposit active rakhein."
        }
      ]
    },
    {
      "@type": "FAQPage",
      "@id": "https://sahayakai.co.in/posts/gem-seller-dashboard-kaise-use-kare#faq",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "GeM Caution Money status kaise check karein?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Dashboard me login karke profile section me Caution Money option par click karein aur apna active status aur bank linkage verify karein."
          }
        },
        {
          "@type": "Question",
          "name": "GeM Seller Dashboard par Bids tabs me kya dikhta hai?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Bids tabs me Ongoing Bids, Participated Bids, aur Bid Status dikhta hai jisse aap live tenders aur apne participated tenders ka status trace kar sakte hain."
          }
        }
      ]
    },
    {
      "@type": "BreadcrumbList",
      "@id": "https://sahayakai.co.in/posts/gem-seller-dashboard-kaise-use-kare#breadcrumb",
      "itemListElement": [
        {
          "@type": "ListItem",
          "position": 1,
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "GeM Seller Dashboard Guide",
          "item": "https://sahayakai.co.in/posts/gem-seller-dashboard-kaise-use-kare"
        }
      ]
    }
  ]
