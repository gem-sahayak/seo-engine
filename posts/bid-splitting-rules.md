...
description: "Learn about bid splitting rules on GeM, GFR 2017 procurement policies, and low-value direct purchase comparison thresholds."
slug: "bid-splitting-rules"
category: "GeM Bidding"
tags: ["Bid Splitting", "GFR Compliance", "Purchase Limits"]
...
faqs:
  - q: "What is bid splitting on GeM?"
    a: "Bid splitting is the practice of breaking down a large single order into multiple small purchases to bypass mandatory bidding thresholds."
  - q: "How is purchase preference split among MSEs?"
    a: "If an MSE seller's price falls within the L1 + 15% band, they are allowed to match the L1 price to receive a portion (up to 25%) of the total order."
relatedTools:
  - "l1-margin-calculator"
relatedArticles:
  - "gem-bidding-rules-handbook"
  - "single-bid-compliance"
---
...
General Financial Rules (GFR) prohibit splitting demands or purchasing goods in small values to avoid the necessity of obtaining the sanction of higher authorities. 
For instance, a buyer cannot make five direct purchases of ₹40,000 each in a single week for the same item to bypass the ₹50,000 threshold that would otherwise require L1 comparison.
