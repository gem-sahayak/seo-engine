...
description: "Learn how to register as a seller on the Government e-Marketplace (GeM) portal in 2026. Complete step-by-step registration manual with documents and checklist."
slug: "complete-gem-registration-guide"
category: "GeM Registration"
tags: ["GeM Onboarding", "Seller Registration", "MSME Bidding"]
...
keyTakeaways:
  - "Seller registration on the official GeM portal is free of cost."
  - "Aadhaar-linked mobile number and active PAN are mandatory first requirements."
  - "MSMEs must link their Udyam registration to claim bidding exemptions."
faqs:
  - q: "Is there any fee to register as a seller on GeM?"
    a: "No, there is no official registration fee on the GeM portal. Watch out for third-party entities asking for payments."
  - q: "Can a proprietor register without a separate company PAN?"
    a: "Yes, sole proprietorships can register on GeM using their personal PAN card details."
relatedTools:
  - "eligibility-checker"
...
1. Open the official website at [https://gem.gov.in](https://gem.gov.in) and click on **Sign Up** -> **Seller**.
2. Select your business organization type (e.g., Sole Proprietorship, Partnership, Company, or Trust).
3. Read the Terms and Conditions agreement carefully and accept it.
...
1.  **Caution Money Deposit:** Depending on your turnover, you must deposit caution money (varying from ₹5,000 to ₹10,000 for non-exempted sellers) into the GeM bank account.
2.  **Vendor Assessment:** If you are a manufacturing firm, you must complete the manufacturing vendor assessment process conducted by QCI (Quality Council of India).
