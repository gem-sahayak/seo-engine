...
sources:
  ...
  - "GeM Seller Manual for Order Fulfillment"
cta: "SLA notification aur order updates directly WhatsApp par pane ke liye SahayakAI Chrome Extension try karein."
keyTakeaways:
  - "GeM orders ko notify hone ke 10 calendar days ke andar accept karna mandatory hota hai."
  - "10-day SLA cross hone par order automatically cancel ho jata hai, aur seller ke profile rating par negative impact padta hai."
  - "Order acceptance process ke liye Aadhaar OTP ya Digital Signature Certificate (DSC) mandatory hai."
  - "Acceptance ke baad system automatically Default Contract generate karta hai jo delivery aur auditing ke liye valid agreement hota."
faqs:
  - q: "GeM portal par order accept karne ki time limit kya hai?"
    a: "GeM portal par order release hone ke baad seller ko use 10 calendar days ke andar accept karna hota hai. Ise SLA timeline kaha jata hai."
  - q: "Agar 10 days ke andar order accept na karein toh kya hoga?"
    a: "Agar 10-day SLA period me order accept nahi kiya jata, toh order automatically cancel ho jata hai aur buyer bina kisi penalty ke naya process shuru kar sakta hai."
relatedTools:
  - "SahayakAI Order Alert Chrome Extension"
  - "SahayakAI Bid and Tender Tracker"
relatedArticles:
  - "gem-order-cancel-rules"
  - "gem-portal-par-order-kaise-milega"
...
<div class="hero-badge-container">
  <span class="badge category-badge">Order Management</span>
...
<div class="hero-summary-box">
  <p><strong>GeM portal par order notification aane ke baad 10-day SLA timeline ke andar use accept karna har seller ke liye sabse important task hai.</strong> Agar aap is deadline ko miss karte hain, toh order automatic cancel ho jata hai aur aapki rating gir jati hai. Is guide me hum step-by-step samjhenge ki naya order notification aane par default contract print karne se lekar, digital signature verify karke order accept karne ka sahi tarika kya hai.</p>
</div>
...
<div class="quick-answer-box">
  <h3>⚡ Quick Answer: GeM Order Acceptance Rules</h3>
  <table>
    <tr>
      <td><strong>Problem</strong></td>
      <td>GeM portal par naya order aane par notification missing hona aur SLA timeline ke andar accept na kar pana.</td>
    </tr>
    <tr>
      <td><strong>SLA Timeline</strong></td>
      <td>Order release hone ke exact <strong>10 Calendar Days</strong> ke andar accept karna mandatory hai.</td>
    </tr>
    <tr>
      <td><strong>Required Action</strong></td>
      <td>Seller Dashboard > Orders > New Orders me jakar order review karein aur Aadhaar OTP ya DSC ke throw accept karein.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>Consequence of Delay</strong></td>
      <td>Order automatically cancel ho jayega. Account par incident log ho sakta hai aur rating zero/negative ho sakti hai.</td>
    </tr>
    <tr>
      <td><strong>Recommended Tool</strong></td>
      <td>Aise automated notifications aur deadlines ko track karne ke liye free <strong>SahayakAI Order Alert Assistant</strong> Chrome extension use karein.</td>
    </tr>
  </table>
</div>
...
3. [Prerequisites Before Accepting an Order](#prerequisites-before-accepting-an-order)
...
6. [Step-by-Step Guide: GeM Order Accept Kaise Kare](#step-by-step-guide-gem-order-accept-kaise-kare)
7. [Decision Tree: Order Acceptance Workflow](#decision-tree-order-acceptance-workflow)
8. [⚠️ Important Warning & SLA Compliance](#️-important-warning--sla-compliance)
9. [Comparison Table: GeM Online Order vs Offline Manual Order](#comparison-table-gem-online-order-vs-offline-manual-order)
...
> [!WARNING]
> **10-day SLA Line Ko Maze me Na Lein!**
> GeM portal rule ke mutabik order generate hone ke exact 10 days ke baad portal automatic buyer ko "Cancel without penalty" ka switch de deta hai. Isse aapka order cancel toh hoga hi, sath hi block incident ke tehat aapka profile trust rating score down ho jayega. Bidding rules me auto-cancellation record aane par upcoming bids reject ho sakti hain. Isliye order alert aate hi 48 ghante me digital validation complete karein.
...
<div class="knowledge-journey-container">
  <div class="journey-step previous-step">
    ...
    <strong><a href="/posts/gem-portal-par-order-kaise-milega">Order Kaise Milega</a></strong>
  </div>
  <div class="journey-arrow">↓</div>
  <div class="journey-step current-step">
    <span class="journey-label">Current Guide</span>
    <strong>Order Accept Kaise Kare</strong>
  </div>
  <div class="journey-arrow">↓</div>
  <div class="journey-step next-step">
    <span class="journey-label">Next Step</span>
    <strong><a href="/posts/gem-order-cancel-rules">Order Cancellation Rules</a></strong>
  </div>
</div>
...
<div class="extension-cta-box">
  <h3>🧩 SLA Miss Karne Se Bachein!</h3>
  <p>GeM portal par naye order notification aur SLA tracking ke alerts pane ke liye aap humare free educational <strong>SahayakAI Order Alert Assistant</strong> ka upayog kar sakte hain. Yeh aapko time par notify karega taaki 10-day deadline kabhi miss na ho.</p>
</div>
...
- **GeM LMS & Training Manuals**: [lms.gem.gov.in](https://lms.gem.gov.in)
