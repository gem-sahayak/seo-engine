---
title: "The Ultimate Guide to Udyam Registration & MSME Exemptions on Gem Portal"
...
1. Log in to your seller dashboard on `gem.gov.in`.
2. Go to **My Account** and select the **Company Profile** tab.
3. Click on **MSE Details** and enter your Udyam Registration Number and registered mobile number.
4. Click **Verify and Save**. The portal will fetch your details from the MSME database and update your seller status.
