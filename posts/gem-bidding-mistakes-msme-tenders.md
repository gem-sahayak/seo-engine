...
## 1. Missing or Invalid 'Make in India' (MII) Certificates

If a tender has a preference for local suppliers under the **Public Procurement (Preference to Make in India) Order**, you must upload a valid MII local content declaration.
* **The Mistake**: Uploading a generic self-declaration without specifying the exact percentage of local content or the location of manufacturing.
* **The Fix**: Ensure your certificate explicitly mentions: *"Local content is X% and manufacturing/assembly takes place at address Y."* For bids above ₹10 crores, this must be certified by a chartered accountant.

---

## 2. Failing the Turnover & Past Experience Criteria

Buyers set strict criteria for past experience (e.g., *"Seller must have completed 3 similar works in the last 3 years"*).
* **The Mistake**: Bidding without verifying if your Udyam registration or previous invoice values match the mandatory criteria.
* **The Fix**: Use analytical tools to double-check past tender history. If you do not meet the criteria, seek out "MSME Exemption" clauses if the buyer has enabled them.
...
## 4. Disregarding Corrigendum Updates
